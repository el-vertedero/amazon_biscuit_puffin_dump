...
# ProjectConfig.mk
# This file aggregates a large set of variable definitions provided
# by MTK, for use in building components from the MTK source tree.
#
# We have defined our own hierarchy within ProjectConfig.mk
#
# The order of includes is important. Definitions from more common
# layers are included first, and more specific definitions are included
# last.  This allows the more-specific files to override more common
...
CUSTOM_KERNEL_ACCELEROMETER = inv_icm20645
CUSTOM_KERNEL_ALSPS =
...
CUSTOM_KERNEL_GYROSCOPE = inv_icm20645
...
CUSTOM_KERNEL_TOUCHPANEL = atmel_mat_ts
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = nt35521_wxga_dsi_vdo_hh060ia
CUSTOM_MODEM =
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = NT35521_WXGA_DSI_VDO_HH060IA
...
# TODO: enabling this causes compilation failure for mt8163. Follow up with MTK
#MTK_AUDIO = yes
...
TARGET_MDUMP_COMPRESS = no
BOARD_AMAZON_KERNEL_SIGNING = true
IDME_SUPPORT = yes
AMZN_DHA = yes
AMZN_DRMPROV = yes
TARGET_PREBUILT_TEE = vendor/amazon/signed-images/$(MTK_TARGET_PROJECT)/$(TARGET_BUILD_VARIANT)/tz.img
TARGET_PREBUILT_PRELOADER = vendor/amazon/signed-images/$(MTK_TARGET_PROJECT)/$(TARGET_BUILD_VARIANT)/preloader.bin
TARGET_PREBUILT_LK = vendor/amazon/signed-images/$(MTK_TARGET_PROJECT)/$(TARGET_BUILD_VARIANT)/lk.bin
AMAZON_8163_TLV_ADCDAC_SUPPORT = yes
BOARD_CHARGER_DET = true
AMZN_LIBLIGHTS_USE_STUB = true
